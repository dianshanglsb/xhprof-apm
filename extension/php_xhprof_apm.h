...
#define register_trace_callback(function_name, cb) zend_hash_str_update(APM_G(trace_callbacks), function_name, sizeof(function_name) - 1, &cb);
...
typedef struct hp_entry_t {
    ...
    uint64                  tsc_start;
    uint64                  cpu_start;/* start value for TSC counter  */
